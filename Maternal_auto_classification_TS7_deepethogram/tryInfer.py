...
if __name__ == '__main__':
    ...
    data_path = os.path.join(project_path, "DATA")
    feature_weights = r"D:\LBN\Maternal_auto_classification_train_deepethogram\models\250610_173633_feature_extractor_train\lightning_checkpoints\epoch=1-step=1999.ckpt"
