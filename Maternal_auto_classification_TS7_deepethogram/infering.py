...
if __name__ == '__main__':
    ...
    data_path = os.path.join(project_path, "DATA")
    feature_weights = r"D:\LBN\Maternal_auto_classification_train_LBN_deepethogram\models\250709_172252_feature_extractor_train\lightning_checkpoints\epoch=5-step=5999.ckpt"
    flow_weights = r"D:\LBN\Maternal_auto_classification_TS7_deepethogram\models\250602_134424_flow_generator_train\lightning_checkpoints\epoch=0-step=999.ckpt"
    ...
    cfg.sequence.weights = r"D:\LBN\Maternal_auto_classification_TS7_deepethogram\models\250616_145332_sequence_train\lightning_checkpoints\epoch=24-step=16349.ckpt"
